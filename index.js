...
function checkDataType(value) {
  ...
  return `Значення "${value}" має тип "${typeof value}"`;
...
function memoizedArea() {
  ...
  return function squareArea(side) {
    ...
    if (side === prevSide) {
      ...
      return `Calculating result ${side ** 2}`;
    }
  };
